...
//                                 {/* <span className="faShoppingCart text-2xl  m-[6px] text-[#FF9D00] p-[5px] rounded-full h-[40px] w-[40px] border-2 border-solid border-[#333] hover:text-[#f1f1f1] hover:bg-[#FF9D00] cursor-pointer">faShoppingCart</span> */}
...
//                         <p className="para  text-[#f1f1f1] font-bold  "><Link to="/legale"
...
//                             className="fa-brands fa-whatsapp  text-3xl  p-[4px] rounded-full  text-[#FF9D00]  hover:text-[#333] "></i>
//                         </a>
    ...
    return (
        <div>
            <footer className="p-[20px] bg-[#7C1152] rounded-t-[40px] relative md:rounded-t-[90px] mt-10 lg:rounded-t-[120px]">
                ...
                <div className="mx-auto flex justify-center">
                    <p className="marquee text-[#f1f1f1] text-[12px] text-center flex items-center gap-[10px] md:text-[1.2rem] font-Italiano">Propulsé avec❤️ par Aubin Boris Simo (simodev). 2025; tous droits réservés!
