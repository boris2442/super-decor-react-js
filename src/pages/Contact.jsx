...
const Contact = () => {
    ...
    <div class="container-form">
        ...
        <div class="box-form">
            <label for="textarea" className="scrollform">Laisser un message</label>
