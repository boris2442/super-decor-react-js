    ...
    <section className="services w-[100%] min-h-[90vh] bg-[#EDF1EF] p-[50px]" id="services">
      ...
      <div className="container flex justify-around gap-[40px] pt-[40px] flex-wrap">
        {services.map((service, index) => (
          <motion.div
            key={index}
            className="box w-[300px] h-[350px] rounded-[9px] shadow-2xl hover:scale-105 relative"
          ...
          >
            ...
            <div className="h-[30%] p-[20px]">
              ...
              <Link
                to="SeePlusHotel"
                className="absolute text-[13px] text-white hover:text-[#FF9D00] right-0 bottom-0 bg-[#333] p-1"
              >
                Voir plus
              </Link>
            </div>
