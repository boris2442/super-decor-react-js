...
const About = () => {
    return (
        <div>
            <section id="about" className="w-[100%] p-[50px] bg-[#f1f1f1] min-h-[90vh]">
                <div className="section-heading">
                    <h2 className="second-title text-3xl font-bold text-[#333] inline-block relative">À propos de nous!</h2>
                        <span className="text-[#FF9D00] spantexte">Une version simplifiée de nous!</span>
                </div>

                <div className="box-about grid grid-cols-2">
                    <div className="  p-10 rounded-lg shadow-lg w-[100%]  child-box-about">
                        <p className="mt-6 text-lg  leading-relaxed para">
